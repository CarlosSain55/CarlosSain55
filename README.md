...
![License: MIT](https://img.shields.io/badge/License-MIT-fc563c?style=for-the-badge)
🌐 Live demo · 🐙 Source · 👤 Author
</div>
---
📖 About this project
...
TutorGo: matching students with tutors — building a role-based booking platform in CodeIgniter 4.
Teaching a model to see thread — what I learned building a YOLO defect detector for fabric.
A thousand sales rows and a star — designing a warehouse that survives its first OLAP query.
Notes from behind a matcha bar — why I think pulling shots makes me a better engineer.
...
✉️ shruzaimi@gmail.com
🐙 github.com/CarlosSain55
💼 linkedin.com/in/sharif-ruzaimi-syirazi
📱 +60 17-811 7668
</td>
</tr>
</table>
---
📄 License
The code in this repository is released under the MIT License — feel free to read, fork, and learn from it.
...
---
<div align="center">
Built with HTML, CSS, a bit of React, and a lot of matcha.

CSD 34203 — Special Topics in Software Development · CLO3 · 20%
